...
public class Board {
	...
	public int[] tMoves(int ypos, int xpos, boolean colour) {
		...
		for (int row = ypos; row < numRows; row++) {
			if (squares[row][xpos].getType() != PieceType.NONE && squares[row][xpos].getColour() != colour
					&& row != ypos) {
				Edges[0] = row;
				break;
			}
		...
		for (int file = xpos; file < numCols; file++) {
			if (squares[ypos][file].getType() != PieceType.NONE && squares[ypos][file].getColour() != colour
					&& file != ypos) {
				Edges[1] = file;
				break;
			}
	...
	public int[] xMoves(int ypos, int xpos, boolean colour) {
		...
		for (int row = ypos, file = xpos; row < numRows && file < numCols; row++, file++) {
			if (squares[row][file].getType() != PieceType.NONE && squares[row][file].getColour() != colour
					&& row != ypos) {
				Edges[0] = row;
				Edges[1] = file;
				break;
	...
	public boolean isxMoveLegal(int xpos, int ypos, int x2pos, int y2pos) {
		// north east
		if (xpos < x2pos && ypos < y2pos) {
			for (int row = ypos, file = xpos; row <= xMoves(ypos, xpos, squares[ypos][xpos].getColour())[0]
					&& file <= xMoves(ypos, xpos, squares[ypos][xpos].getColour())[1]; row++, file++) {
		...
		// south east
		if (xpos < x2pos && ypos > y2pos) {
			for (int row = ypos, file = xpos; row >= xMoves(ypos, xpos, squares[ypos][xpos].getColour())[2]
					&& file <= xMoves(ypos, xpos, squares[ypos][xpos].getColour())[3]; row--, file++) {
				if (row == y2pos && file == x2pos) {
					return true;
				}
			}
		...
		// south west
		if (xpos > x2pos && ypos > y2pos) {
			for (int row = ypos, file = xpos; row >= xMoves(ypos, xpos, squares[ypos][xpos].getColour())[4]
					&& file >= xMoves(ypos, xpos, squares[ypos][xpos].getColour())[5]; row--, file--) {
				if (row == y2pos && file == x2pos) {
					return true;
				}
			}
		...
		// north west
		if (xpos > x2pos && ypos < y2pos) {
			for (int row = ypos, file = xpos; row <= xMoves(ypos, xpos, squares[ypos][xpos].getColour())[6]
					&& file <= xMoves(ypos, xpos, squares[ypos][xpos].getColour())[7]; row++, file--) {
				if (row == y2pos && file == x2pos) {
					return true;
				}
			}
	...
	public boolean legalPawnMove(int xpos, int ypos, int x2pos, int y2pos) {
		if (squares[ypos][xpos].getColour() == true) {
			...
			if (xpos == x2pos && ypos == y2pos - 2 && squares[y2pos][x2pos].getType() == PieceType.NONE
					&& !squares[ypos][xpos].hasMoved()) {
				return true;
			}

			if (xMoves(ypos, xpos, squares[ypos][xpos].getColour())[0] == y2pos
					&& xMoves(ypos, xpos, squares[ypos][xpos].getColour())[1] == x2pos) {
				return true;
			}

			if (xMoves(ypos, xpos, squares[ypos][xpos].getColour())[6] == y2pos
					&& xMoves(ypos, xpos, squares[ypos][xpos].getColour())[7] == x2pos) {
				return true;
			}
			...
			if (xMoves(ypos, xpos, squares[ypos][xpos].getColour())[2] == y2pos
					&& xMoves(ypos, xpos, squares[ypos][xpos].getColour())[3] == x2pos) {
				return true;
			}

			if (xMoves(ypos, xpos, squares[ypos][xpos].getColour())[4] == y2pos
					&& xMoves(ypos, xpos, squares[ypos][xpos].getColour())[5] == x2pos) {
				return true;
			}
	...
	public boolean legalKnightMove(int xpos, int ypos, int x2pos, int y2pos) {
		...
		if (x2pos == xpos + 1 && y2pos == ypos + 2 && squares[y2pos][x2pos].getType() != PieceType.NONE
				&& squares[y2pos][x2pos].getColour() != squares[ypos][xpos].getColour()) {
			return true;
		}
	...
	public boolean isCheck(int x, int y) {
		if ((squares[tMoves(y, x, squares[y][x].getColour())[0]][x].getType() == PieceType.ROOK
				|| squares[tMoves(y, x, squares[y][x].getColour())[0]][x].getType() == PieceType.QUEEN
				|| squares[tMoves(y, x, squares[y][x].getColour())[0]][x].getType() == PieceType.ROOK)
				&& squares[tMoves(y, x, squares[y][x].getColour())[0]][x].getColour() != squares[y][x].getColour()) {
			return true;
		}

		if ((squares[tMoves(y, x, squares[y][x].getColour())[2]][x].getType() == PieceType.ROOK
				|| squares[tMoves(y, x, squares[y][x].getColour())[2]][x].getType() == PieceType.QUEEN
				|| squares[tMoves(y, x, squares[y][x].getColour())[2]][x].getType() == PieceType.ROOK)
				&& squares[tMoves(y, x, squares[y][x].getColour())[2]][x].getColour() != squares[y][x].getColour()) {
			return true;
		}

		if ((squares[y][tMoves(y, x, squares[y][x].getColour())[1]].getType() == PieceType.ROOK
				|| squares[y][tMoves(y, x, squares[y][x].getColour())[1]].getType() == PieceType.QUEEN
				|| squares[y][tMoves(y, x, squares[y][x].getColour())[1]].getType() == PieceType.ROOK)
				&& squares[tMoves(y, x, squares[y][x].getColour())[1]][x].getColour() != squares[y][x].getColour()) {
			return true;
		}

		if ((squares[y][tMoves(y, x, squares[y][x].getColour())[3]].getType() == PieceType.ROOK
				|| squares[y][tMoves(y, x, squares[y][x].getColour())[3]].getType() == PieceType.QUEEN
				|| squares[y][tMoves(y, x, squares[y][x].getColour())[3]].getType() == PieceType.ROOK)
				&& squares[tMoves(y, x, squares[y][x].getColour())[3]][x].getColour() != squares[y][x].getColour()) {
			return true;
		}

		if ((squares[xMoves(y, x, squares[y][x].getColour())[0]][xMoves(y, x, squares[y][x].getColour())[1]]
				.getType() == PieceType.BISHOP
				|| squares[xMoves(y, x, squares[y][x].getColour())[0]][xMoves(y, x, squares[y][x].getColour())[1]]
						.getType() == PieceType.QUEEN
				|| squares[xMoves(y, x, squares[y][x].getColour())[0]][xMoves(y, x, squares[y][x].getColour())[1]]
		...
		if ((squares[xMoves(y, x, squares[y][x].getColour())[2]][xMoves(y, x, squares[y][x].getColour())[3]]
				.getType() == PieceType.BISHOP
				|| squares[tMoves(y, x, squares[y][x].getColour())[2]][xMoves(y, x, squares[y][x].getColour())[3]]
						.getType() == PieceType.QUEEN
				|| squares[xMoves(y, x, squares[y][x].getColour())[2]][xMoves(y, x, squares[y][x].getColour())[3]]
						.getType() == PieceType.ROOK)
				&& squares[xMoves(y, x, squares[y][x].getColour())[2]][xMoves(y, x, squares[y][x].getColour())[3]]
						.getColour() != squares[y][x].getColour()) {
			return true;
		...
		if ((squares[xMoves(y, x, squares[y][x].getColour())[4]][xMoves(y, x, squares[y][x].getColour())[5]]
				.getType() == PieceType.BISHOP
				|| squares[xMoves(y, x, squares[y][x].getColour())[4]][xMoves(y, x, squares[y][x].getColour())[5]]
						.getType() == PieceType.QUEEN
				|| squares[xMoves(y, x, squares[y][x].getColour())[4]][xMoves(y, x, squares[y][x].getColour())[5]]
						.getType() == PieceType.ROOK)
				&& squares[xMoves(y, x, squares[y][x].getColour())[4]][xMoves(y, x, squares[y][x].getColour())[5]]
		...
		if ((squares[xMoves(y, x, squares[y][x].getColour())[6]][xMoves(y, x, squares[y][x].getColour())[7]]
				.getType() == PieceType.BISHOP
				|| squares[xMoves(y, x, squares[y][x].getColour())[6]][xMoves(y, x, squares[y][x].getColour())[7]]
						.getType() == PieceType.QUEEN
				|| squares[xMoves(y, x, squares[y][x].getColour())[6]][xMoves(y, x, squares[y][x].getColour())[7]]
						.getType() == PieceType.ROOK)
				&& squares[xMoves(y, x, squares[y][x].getColour())[6]][xMoves(y, x, squares[y][x].getColour())[7]]
		...
		for (int i = 0; i < kMoves.size(); i++) {
			if (squares[kMoves.get(i).y2()][kMoves.get(i).x2()].getType() == PieceType.KNIGHT
					&& squares[kMoves.get(i).y2()][kMoves.get(i).x2()].getColour() != squares[y][x].getColour()) {
				return true;
			}
		}
	...
	public boolean legalKingMove(int x1, int y1, int x2, int y2) {
		...
		for (int i = 0; i < kingMoves(x1, y1).size(); i++) {
			if (kingMoves(x1, y1).get(i).x2() == x2 && kingMoves(x1, y1).get(i).y2() == y2
					&& kingMoves(x1, y1).get(i).x() == x1 && kingMoves(x1, y1).get(i).y() == y1) {
				return true;
			}
